...
```{r, echo = F}
GA_sf <- maptools::readShapeSpatial(here::here('Data', 'GA_map.shp')) %>% 
  st_as_sf() %>% 
  mutate(district = 
...
NOTE:: I had one more plotly map here, but had to omit because it was eating into the size of this file and I couldn't upload to GitHub.

## Final {.tabset}

```{r}
b_map_final <- GA_districts %>% 
