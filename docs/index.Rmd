...
Exclusionary Punishments per Student') + 
...
**Middle and high schools with less than ~34% Black students** average just over **1 exclusionary punishment for every 9 students**. 

Among **Middle and high schools with more than ~34% Black students:** 

* schools with **less than 74.75% FRL eligible students** averaged just over **1 exclusionary punishment for every 4 students**. 
* schools with **more than 74.75% FRL eligible students** averaged over **1 exclusionary punishment for every 3 students**. 

**Elementary and K-12 schools with less than 43% Black students** average just over **4 exclusionary punishment per every 100 students**. 

**Elementary and K-12 schools with more than 43% Black students**, average more than **1 exclusionary punishment per every 10 students (or 1 in every 100)**.

This provides evidence that there is significant inequity in distribution of exclusionary punishments per student across schools type (e.g., middle and high school vs. elementary schools and K-12), percent Black students, and percent FRL eligible students. While we can chalk up differences in school type to many factors that are reasonable (e.g., appropriate discipline styles at different ages, types of offenses at different ages, etc.), we **cannot** say the differences in average exclusionary discipline by percent racial or socioeconomic characteristics is reasonable. Next steps should explore interventions which can improve administrative decision-making to minimize such inequity and to conduct student-level analyses on disciplinary data. 
