...
GA_sf <- 
  ...
  mutate(system_name = 
           str_replace(string = NAME, 
                       pattern = " District", ""), 
         system_name = 
           str_replace(string = system_name, 
                       pattern = " Schools", ""), 
         system_name = 
           str_replace(string = system_name, 
                       pattern = " School", "")
...
tm_shape(GA_sf) + 
  tm_polygons('average_oss') + 
  tm_facets(by = 'fac_schtype', drop.NA.facets = T)
#tm_shape(ms_oss) + tm_polygons('average_prop_non_white')
```

```{r}
tm_shape(GA_sf) + 
  tm_polygons('average_prop_non_white') + 
  tm_facets(by = 'fac_schtype', drop.NA.facets = F, textNA = 'Not Reported')
