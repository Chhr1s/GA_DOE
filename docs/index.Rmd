...
#The main problem here seems to be with the scaling of the graph to fit the title and other descriptions. I'd also add theme_minimal to get rid of the gray sides, and maybe accentuate the hue difference for the orange boxes.
...
```{r, echo = F}
#I'm not sure exactly how this relates to the first plot, so some description here would be realyl helpful! Perhaps that could go in the empty Chart C space.
...
```{r, eval = T, include = F}
#Love the state graph! If possible, it would be cool to make this interactive, so that there was only one graph and you could toggle between the different display options! 
